...
const Horarios = () => {
  return (
    <div className="flex">    
      <div className="ml-64 p-8 w-full"> {/* Espacio para el contenido principal */}
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-semibold text-gray-800">Horarios de Alumno</h1>
          {/* Puedes agregar botones de acción, como búsqueda o filtros */}
        ...
        {/* Aquí incluyes el componente de la tabla de horarios */}
        <TableHorarios />
